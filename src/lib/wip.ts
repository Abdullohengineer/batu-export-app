...
export type WipKind = 'raw_not_sent' | 'moyka_not_returned' | 'awaiting_lab' | 'so2_pending' | 'chiqim_open' | 'provisional_weight'
...
export const WIP_KIND_ORDER: WipKind[] = ['awaiting_lab', 'raw_not_sent', 'moyka_not_returned', 'so2_pending', 'chiqim_open', 'provisional_weight']
